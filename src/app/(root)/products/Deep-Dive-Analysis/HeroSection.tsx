    ...
    return (
        ...
        >
            <div className="relative flex flex-col gap-6 h-[500px] w-full items-center justify-center overflow-hidden rounded-lg bg-background p-10">
                ...
                >
                    Discover What&apos;s Driving the Market Today <span className="text-gradient">before they ignite</span>
                </motion.h1>
                <motion.p
                ...
                >
                    From everyday essentials to groundbreaking innovations, explore the products capturing the world&apos;s attention.
                </motion.p>
                <motion.div
