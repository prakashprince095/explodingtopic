...
const SignupSection = () => {
    return (
        <div className="relative flex flex-col items-center justify-center h-auto w-full max-w-6xl px-6 py-12 mx-auto overflow-hidden rounded-lg border bg-background md:h-[300px] md:px-12 lg:flex-row">
            ...
            <BorderBeam size={250} duration={12} delay={9} className="absolute inset-0" />
        </div>
    );
};
